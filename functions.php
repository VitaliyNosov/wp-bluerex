...
if ( ! function_exists( 'bluerex_setup' ) ) :
	...
	function bluerex_setup() {
		...
		// Функция для регистрации меню на сайте
...
// Сдесь регистрируем наши виджеты
...
// Подключаем стили и скрыпти из папки assets
...
// Фукция для фонового изображения на первом экране
...
// Регистрируем наши произвольные типы записи:

// Описание функции: https://wp-kama.ru/function/register_post_type
...
// Функция которая удаляет не красый заголовок в пагинации

// Подробнее: https://wp-kama.ru/function/the_posts_navigation
...
// Функция которая позволяет ограничь вывод постов которые мы не хотим что бы отображались
// Значения указываем в цифрах их можно посмотреть в админ-панели
