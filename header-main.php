...
<header class="main-header" <?php echo bluerex_get_background('header_bg') ?>>
                            ...
                            <!-- Выводим нашу функцию которую мы создали для работы с фоновым изображением -->

    <nav class="navbar navbar-expand-lg">
    
        <a class="navbar-brand" href="<?php echo home_url('/') ?>">

            <!-- Так мы выводим наше лого динамически -->
    ...
    <!-- Выведем наш контенд динамически -->

     <div class="main-header-text">

        <?php if( get_field('header 1') ): ?>
            <h3><?php the_field('header 1') ?></h3>
        <?php endif; ?>
        <?php if( get_field('header 2') ): ?>
            <h4><?php the_field('header 2') ?></h4>
        <?php endif; ?>
